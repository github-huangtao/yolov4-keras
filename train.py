...
def _main():
    ...
    model = create_model(input_shape, anchors, num_classes,
        freeze_body=2, load_pretrained=False,weights_path='model_data/yolo4.h5') # make sure you know what you freeze
    ...
    train_times=train_times/3600
    print(str(train_times).join('h'))
...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
            weights_path='model_data/yolo4.h5'):
